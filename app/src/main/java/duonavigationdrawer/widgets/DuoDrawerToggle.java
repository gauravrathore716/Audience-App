...
import com.b2c.audience.MainActivity;
...
public class DuoDrawerToggle implements DrawerListener {
    ...
    public DuoDrawerToggle(Activity activity, DuoDrawerLayout duoDrawerLayout,
                           ...
                           Drawable upArrow,View sliderView ) {
        this(activity, null, duoDrawerLayout, null, openDrawerContentDescRes,
                closeDrawerContentDescRes,upArrow,sliderView);
    }
    ...
    public DuoDrawerToggle(Activity activity, DuoDrawerLayout duoDrawerLayout,
                           ...
                           @StringRes int closeDrawerContentDescRes,Drawable upArrow,View sliderView )
    {
...
//            MainActivity.binding.layoutMain.setBackground(null);
//            MainActivity.binding.toolbar.setBackground(null);
//            MainActivity.binding.appbarLayout.setBackground(null);
//            MainActivity.binding.layoutMain.setBackground(null);
//            MainActivity.binding.toolbar.setBackground(null);
//            MainActivity.binding.appbarLayout.setBackground(null);
//            MainActivity.binding.layoutMain.setPadding(0,0,0,0);

        }
        else {
           mDuoDrawerLayout.openDrawer(GravityCompat.START);
//            MainActivity.binding.drawer.setBackground(ContextCompat.getDrawable(mContext,R.drawable.layout_radius_bg));

//            MainActivity.binding.appbarLayout.setBackground(ContextCompat.getDrawable(mContext,R.drawable.card_bg_top_radius));
//            MainActivity.binding.layoutMain.setPadding(0,0,30,30);
...
//        MainActivity.binding.appbarLayout.setBackground(ContextCompat.getDrawable(mContext,R.drawable.card_bg_top_radius));
//        MainActivity.binding.layoutMain.setBackground(ContextCompat.getDrawable(mContext,R.drawable.layout_radius_bg));
//        MainActivity.binding.layout.setBackground(ContextCompat.getDrawable(mContext,R.drawable.layout_on_toggle_start));
//        MainActivity.binding.viewPager.setBackground(ContextCompat.getDrawable(mContext,R.drawable.layout_on_toggle_start));
//        MainActivity.binding.toolbar.setBackground(ContextCompat.getDrawable(mContext,R.drawable.card_bg_top_radius));
...
//        MainActivity.binding.toolbar.setBackgroundResource(R.color.colorPrimary);
//        MainActivity.binding.appbarLayout.setBackgroundResource(R.color.colorPrimary);
//        MainActivity.binding.layout.setBackgroundResource(R.color.white);
//        MainActivity.binding.viewPager.setBackgroundResource(R.color.white);
...
//        MainActivity.binding.layoutMain.setPadding(0,0,0,0);
    ...
    public void onDrawerStateChanged(int newState) {
        ...
        //mDuoDrawerLayout.setBackground(ContextCompat.getDrawable(mContext,R.drawable.card_bg_top_radius));
    }
    ...
    static class ToolbarCompatDelegate implements Delegate {
        ...
        public void setActionBarUpIndicator(Drawable upDrawable, @StringRes int contentDescRes) {
            mToolbar.setNavigationIcon(R.drawable.menu_48);
